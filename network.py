...
class ResBase(nn.Module):
    def __init__(self, res_name):
        ...
        res_dict = {
            ...
            "resnet50_v1": models.resnet50(weights="IMAGENET1K_V1"),
            "resnet50_nopre": models.resnet50(pretrained=False),
        }
...
class EffBase(nn.Module):
    def __init__(self, res_name):
        ...
        eff_dict = {
            ...
            "efficientnet_v2_m": models.efficientnet_v2_m(weights="IMAGENET1K_V1"),
            "efficientnet_v2_l": models.efficientnet_v2_l(weights="IMAGENET1K_V1"),
        }
        self.eff = copy.deepcopy(eff_dict[res_name])
        self.in_features = self.eff.classifier[1].in_features
        self.eff.classifier = nn.Sequential()
...
class SwinBase(nn.Module):
    def __init__(self, res_name):
        ...
        swin_dict = {
            ...
            "swin_b": models.swin_b(weights="IMAGENET1K_V1"),
        ...
        if res_name == "swin_l":
            ...
            )  # SwinForImageClassification.from_pretrained("microsoft/swin-large-patch4-window7-224")
            self.pool = self.swin.head.global_pool
        else:
            self.swin = copy.deepcopy(swin_dict[res_name])
        self.in_features = self.swin.head.in_features
